...
public enum BusinessStatus implements ExceptionKeyAndMessage {
    ...
    USER_NOT_FOUND(1019, HttpResponseConstants.ERROR, "User not found"),
    EVENTREQUEST_NOT_FOUND(1020, HttpResponseConstants.ERROR, "Event request not found"),
    MINIO_ERROR(1024, HttpResponseConstants.ERROR, "Minio error"),
    DUPLICATE_REQUEST(1025, HttpResponseConstants.ERROR, "Duplicate request detected"),
    EVENT_CATEGORY_NOT_FOUND(1025, HttpResponseConstants.ERROR, "Duplicate request detected");
